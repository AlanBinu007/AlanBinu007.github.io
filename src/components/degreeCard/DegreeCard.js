            ...
            <div className="card-body">
              ...
              >
                <div className="body-header-title">
                  ...
                  {/* <h3 className="card-subtitle1">
                  Foreign Equivalency :  BACHELOR'S DEGREE
                    &nbsp;(Verifyed By WES )
                  </h3> */}
                  2017 - 2020
                </div>
          ...
          <Fade right duration={2000} distance="40px">
            <div className="card-body">
              ...
              <div classname="body-content">
                ...
                <p className="content-list" style={{ color: theme.text }}>
                  <br />
                  ⚡ Learn to combine excellence in the application of technical
                  capacity with interpersonal and leadership skills.
                  <br />
                  <br />⚡ Deepening in the context of globalization to which we
                  are exposed to be able to operate in this new culture of
                  continuous innovation.
                  <br />
                  <br />⚡ Discover the five technologies that are transforming
                  our societies and how they are doing it: blockchain, cloud
                  computing, AI, IoT and cybersecurity.
                  <br />
                  <br />⚡ Get familiar with cloud computing and DevOps to
                  analyze the best way to harness its potential and achieve a
                  secure software design, as well as efficient technological
                  operations.
                  <br />
                  <br />⚡ Develop a deeper insight about blockchain
                  fundamentals and its practical applications.
                  <br />
                </p>
            ...
            <div className="card-body">
              ...
              <div classname="body-content">
                ...
                <p className="content-list" style={{ color: theme.text }}>
                  ...
                  <br />
                  <br />
                  ⚡ Craft sound survey questions and draw conclusions from
                  population samples
                  <br />
                  <br />
                  ⚡Implement regression analysis and other analytical
                  techniques in Excel
                  <br />
                </p>
