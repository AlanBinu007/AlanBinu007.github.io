      ...
      <Fade bottom duration={2000} distance="20px">
        <div className="blog-heading-div">
          ...
          <div className="blog-heading-text-div">
            <h2 className="blog-heading-text">My Blogs</h2>
            <p
            ...
            <p
              ...
              style={{ color: theme.secondaryText }}
            >
              "I’m a big believer in sharing my failures as well as my
              successes, so (readers) know what works and what doesn’t"
            </p>
            <p
              className="blog-header-detail-text subTitle"
              style={{ color: theme.secondaryText }}
            >
              "Tell a story. Make it true. Make it compelling. And make it
              relevant"
            </p>
              ...
              >
                <div class="blog-item-wrapper">
                  ...
                  <div class="blog-item-text">
                    ...
                    <h3>
                      Spring Boot🔥 Do i need to study in 2022 to get a Job?🤔
                    </h3>
                    <div class="meta-tags">
                      <span>
      ...
      <section id="blog" class="section">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4">
              <a
                href="https://alanbinu.hashnode.dev/how-to-get-started-with-artificial-intelligence"
                target="_blank"
              >
                <div class="blog-item-wrapper">
                  <div class="blog-item-img">
            ...
            <div class="col-lg-4">
              <a
                href="https://alanbinu.hashnode.dev/best-way-to-learn-react-from-scratch"
                target="_blank"
              >
                <div class="blog-item-wrapper">
                  <div class="blog-item-img">
      ...
      <section id="blog" class="section">
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              <a
                href="https://alanbinu.hashnode.dev/how-to-use-linkedin-to-get-a-job-1"
                target="_blank"
              >
                <div class="blog-item-wrapper">
                  <div class="blog-item-img">
            ...
            <div class="col-lg-4">
              <a
                href="https://alanbinu.hashnode.dev/best-extensions-for-vs-code-to-better-coding"
                target="_blank"
              >
                <div class="blog-item-wrapper">
                  <div class="blog-item-img">
            ...
            <div class="col-lg-4">
              <a
                href="https://alanbinu.hashnode.dev/angular-vs-reactjs-vs-vue-the-real-battle"
                target="_blank"
              >
                <div class="blog-item-wrapper">
                  <div class="blog-item-img">
